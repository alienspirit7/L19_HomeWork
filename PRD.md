...
**Input:**
- Gmail account: `elena.nur.study@gmail.com`
...
class Settings(BaseSettings):
    ...
    gmail_account: str = Field(default="elena.nur.study@gmail.com")
...
- Log in to elena.nur.study@gmail.com
- Grant permissions
